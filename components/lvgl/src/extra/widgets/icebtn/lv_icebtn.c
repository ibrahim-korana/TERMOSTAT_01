 ...
 *      DEFINES
 *********************/
#define MY_CLASS &lv_icebtn_class
 ...
 *  STATIC PROTOTYPES
 **********************/
static void lv_icebtn_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj);
static void draw_main(lv_event_t * e);
static void lv_icebtn_event(const lv_obj_class_t * class_p, lv_event_t * e);
static void refr_img(lv_obj_t * imgbtn);
static lv_imgbtn_state_t suggest_state(lv_obj_t * imgbtn, lv_icebtn_state_t state);
lv_imgbtn_state_t get_state(const lv_obj_t * imgbtn);

/**********************
 *  STATIC VARIABLES
 **********************/
const lv_obj_class_t lv_icebtn_class = {
    .base_class = &lv_obj_class,
    .instance_size = sizeof(lv_icebtn_t),
    .constructor_cb = lv_icebtn_constructor,
    .event_cb = lv_icebtn_event,
};
 ...
 */
lv_obj_t * lv_icebtn_create(lv_obj_t * parent)
{
    LV_LOG_INFO("begin");
 ...
 * to a file)
 */
void lv_icebtn_set_src(lv_obj_t * obj, lv_icebtn_state_t state, const void * src_left, const void * src_mid,
                       const void * src_right)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj;
...
void lv_icebtn_set_label(lv_obj_t *obj, lv_icebtn_state_t state, char *txt)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj; 
    imgbtn->text[state] = txt;
    refr_img(obj);
}

void lv_icebtn_set_state(lv_obj_t * obj, lv_icebtn_state_t state)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);

    lv_state_t obj_state = LV_STATE_DEFAULT;
    if(state == LV_ICEBTN_STATE_PRESSED || state == LV_ICEBTN_STATE_CHECKED_PRESSED) obj_state |= LV_STATE_PRESSED;
    if(state == LV_ICEBTN_STATE_DISABLED || state == LV_ICEBTN_STATE_CHECKED_DISABLED) obj_state |= LV_STATE_DISABLED;
    if(state == LV_ICEBTN_STATE_CHECKED_DISABLED || state == LV_ICEBTN_STATE_CHECKED_PRESSED ||
       state == LV_ICEBTN_STATE_CHECKED_RELEASED) {
 ...
 */
const void * lv_icebtn_get_src_left(lv_obj_t * obj, lv_icebtn_state_t state)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
 ...
 */
const void * lv_icebtn_get_src_middle(lv_obj_t * obj, lv_icebtn_state_t state)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj;
 ...
 * @return pointer to the left image source (a C array or path to a file)
 */
const void * lv_icebtn_get_src_right(lv_obj_t * obj, lv_icebtn_state_t state)
{
    LV_ASSERT_OBJ(obj, MY_CLASS);
    lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj;
...
static void lv_icebtn_constructor(const lv_obj_class_t * class_p, lv_obj_t * obj)
{
    ...
    lv_memset_00(imgbtn->text, sizeof(imgbtn->text));
...
static void lv_icebtn_event(const lv_obj_class_t * class_p, lv_event_t * e)
{
    ...
    lv_res_t res = lv_obj_event_base(&lv_icebtn_class, e);
    ...
    if(code == LV_EVENT_PRESSED || code == LV_EVENT_RELEASED || code == LV_EVENT_PRESS_LOST) {
        ...
        lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj;
        lv_icebtn_state_t state  = suggest_state(obj, get_state(obj));
 ...
 */
static lv_icebtn_state_t suggest_state(lv_obj_t * obj, lv_icebtn_state_t state)
{
    lv_icebtn_t * imgbtn = (lv_icebtn_t *)obj;
    if(imgbtn->img_src_mid[state] == NULL) {
        switch(state) {
            case LV_ICEBTN_STATE_PRESSED:
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_RELEASED]) return LV_ICEBTN_STATE_RELEASED;
                break;
            case LV_ICEBTN_STATE_CHECKED_RELEASED:
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_RELEASED]) return LV_ICEBTN_STATE_RELEASED;
                break;
            case LV_ICEBTN_STATE_CHECKED_PRESSED:
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_CHECKED_RELEASED]) return LV_ICEBTN_STATE_CHECKED_RELEASED;
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_PRESSED]) return LV_ICEBTN_STATE_PRESSED;
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_RELEASED]) return LV_ICEBTN_STATE_RELEASED;
                break;
            case LV_ICEBTN_STATE_DISABLED:
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_RELEASED]) return LV_ICEBTN_STATE_RELEASED;
                break;
            case LV_ICEBTN_STATE_CHECKED_DISABLED:
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_CHECKED_RELEASED]) return LV_ICEBTN_STATE_CHECKED_RELEASED;
                if(imgbtn->img_src_mid[LV_ICEBTN_STATE_RELEASED]) return LV_ICEBTN_STATE_RELEASED;
                break;
            default:
...
lv_icebtn_state_t get_state(const lv_obj_t * imgbtn)
{
